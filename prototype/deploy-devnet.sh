...
FACTORY=$(dep src/FrontierBookFactory.sol:FrontierBookFactory --constructor-args $REGISTRY)
ROUTER=$(dep src/periphery/FrontierRouter.sol:FrontierRouter --constructor-args $FACTORY)
