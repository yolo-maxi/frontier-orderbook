...
const groups = [
  {
    title: 'Takers',
    rows: [
      { label: 'Market order through one maker’s ladder (20 levels)', gas: 153774 },
      { label: 'Market order crossing 5 distinct maker orders', gas: 198987 },
      { label: 'Market order crossing 50 distinct maker orders', gas: 798562 },
      { label: 'Deep sweep: one maker, 500 price levels', gas: 169853 },
      { label: 'Deep sweep: one maker, 5,000 price levels', gas: 214805 },
      { label: 'Same, on the production 1.0001^tick curve (5,000 levels)', gas: 196937 },
      { label: 'Sell into 500 bid levels', gas: 145376 },
      { label: 'Crossing an empty 2,560-tick price gap', gas: 192785 },
    ],
  },
  {
    title: 'Makers',
    rows: [
      { label: 'Place a flat ladder (any width up to ~100k ticks)', gas: 231393 },
      { label: 'Place a shaped (front-weighted) ladder', gas: 303326 },
      { label: 'Place a bid ladder', gas: 230054 },
      { label: 'Requote: re-price a ladder in place, no token movement', gas: 112915 },
      { label: 'Requote a bid ladder', gas: 119671 },
      { label: 'Claim fills (with off-chain witness)', gas: 69455 },
      { label: 'Claim fills (pure on-chain, binary search)', gas: 53533 },
      { label: 'Cancel: refund unfilled + pay out fills', gas: 92576 },
      { label: 'Recycle a filled bid into a new ask (zero transfers)', gas: 181503 },
    ],
  },
  {
    title: 'Venue',
    rows: [
      { label: 'Create a whole new market (book contract via factory)', gas: 9058262 },
    ],
  },
]
